package ar.com.ada.sb.security.jwt.component.security;

import ar.com.ada.sb.security.jwt.model.dto.security.JwtUserDetails;
...
public class JwtAuthProvider {
    ...
    public static final String CLAIM_KEY_CREATE = "create_at";

    public JwtUserDetails createJwtUserDetails(User user) {
        Set<SimpleGrantedAuthority> authoritySet = user.getAuthorities()
                .stream()
    ...
    public String doGeneratedToken(UserDetails userDetails) {
        ...
        claims.put("roles", jwtUserDetails.getPassword());
